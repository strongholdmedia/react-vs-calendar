...
describe("with viewDate", () =>
{
    it("date value", () =>
    {
        const date = new Date(2000, 0, 15, 2, 2, 2, 2),
            ...
            component = utils.createCalendar({ viewDate: date });
    ...
    it("moment value", () =>
    {
        const date = new Date(2000, 0, 15, 2, 2, 2, 2),
            ...
            component = utils.createCalendar({ viewDate: mDate });
    ...
    it("string value", () =>
    {
        const date = new Date(2000, 0, 15, 2, 2, 2, 2),
            ...
            component = utils.createCalendar({ viewDate: strDate });
    ...
    it("UTC value from UTC string", () =>
    {
        const date = new Date(2000, 0, 15, 2, 2, 2, 2),
            ...
            component = utils.createCalendar({ viewDate: strDateUTC, utc: true });
    ...
    it("viewDate -> picker should change the initial month (viewMode=months)", () =>
    {
        const preDate = new Date(2000, 0, 15, 2, 2, 2, 2),
            ...
            component = utils.createCalendar({ viewDate: preDate });
