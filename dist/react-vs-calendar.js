...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Calendar"] = factory(require("React"), require("moment"), require("ReactDOM"));
	else
		root["Calendar"] = factory(root["React"], root["moment"], root["ReactDOM"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_27__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(1),
	    ...
	    CalendarContainer = __webpack_require__(21),
	    onClickOutside = __webpack_require__(26).default
	;
	...
	var Calendar = createClass({
	    ...
	    getFormats: function (props)
	    {
	        ...
	        if (formats.time === true) { formats.time = locale.longDateFormat("LT"); }
	    ...
	    checkTZ: function (props)
	    {
	        ...
	        if (props.displayTimeZone && !this.tzWarning && !moment.tz) {
	            this.tzWarning = true;
	            con && con.error("react-vs-calendar: displayTimeZone prop with value \"" + props.displayTimeZone +  "\" is used but moment.js timezone is not loaded.");
	        }
	    },
	    componentProps: {
	...
	var ClickableWrapper = onClickOutside(createClass({
	    ...
	    handleClickOutside: function (e) { this.props.onClickOut(e); }
	}));
	...
	// Make moment accessible through the Calendar class
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(13),
	    createClass = __webpack_require__(12),
	    DaysView = __webpack_require__(22),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DateTimePickerDays = createClass({
	    render: function ()
	    {
	        ...
	        tableChildren = [
	            React.createElement("thead", { key: "th" }, [
	                ...
	                React.createElement("tr", { key: "d" }, this.getDaysOfWeek(locale).map(function (day, index)
	                {
	    ...
	    updateSelectedDate: function (event) { this.props.updateSelectedDate(event, true); },
	    ...
	    alwaysValidDate: function () { return 1; }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DateTimePickerMonths = createClass({
	    ...
	    updateSelectedMonth: function (event) { this.props.updateSelectedDate(event); },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DateTimePickerYears = createClass({
	    ...
	    updateSelectedYear: function (event) { this.props.updateSelectedDate(event); },
	    renderYear: function (props, year) { return React.createElement("td", props, year); },
	    alwaysValidDate: function () { return 1; },
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DateTimePickerTime = createClass({
	    ...
	    render: function ()
	    {
	        ...
	        if (this.state.daypart !== false) { counters.push(me.renderDayPart()); }
